 ...
 * @since 1.0.0
 */
public class OpenApiNamespaceClientV2 extends OpenApiTemplateClient implements NamespaceClient {
    ...
    public OpenApiNamespaceClientV2(OpenApiClient openApiClient, NacosClientConfig nacosClientConfig) {
