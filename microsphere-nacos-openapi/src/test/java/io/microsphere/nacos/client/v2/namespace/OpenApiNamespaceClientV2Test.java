...
import io.microsphere.nacos.client.v1.namespace.OpenApiNamespaceClientTest;
 ...
 * @since 1.0.0
 */
public class OpenApiNamespaceClientV2Test extends OpenApiNamespaceClientTest {

    @Override
    protected NamespaceClient createNamespaceClient() {
        return new OpenApiNamespaceClientV2(this.openApiClient, this.nacosClientConfig);
    }
}
