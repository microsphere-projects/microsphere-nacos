...
import io.microsphere.nacos.client.discovery.spring.cloud.NacosDiscoveryClient;
import io.microsphere.nacos.client.discovery.spring.cloud.NacosDiscoveryContextFactory;
import io.microsphere.nacos.client.discovery.spring.cloud.NacosDiscoveryProperties;
...
public class NacosDiscoveryAutoConfiguration {
    ...
    public static class Single {
        ...
        public OpenApiHttpClient openApiHttpClient(NacosDiscoveryProperties nacosDiscoveryProperties) {
            return new OpenApiHttpClient(nacosDiscoveryProperties);
        }

        @Bean
        public NacosDiscoveryClient nacosDiscoveryClient(OpenApiHttpClient openApiHttpClient,
                                                         NacosDiscoveryProperties nacosDiscoveryProperties) {
            return new NacosDiscoveryClient(openApiHttpClient, nacosDiscoveryProperties);
        }
    ...
    public static class Multiple {
        ...
        @Bean
        public NacosDiscoveryContextFactory nacosDiscoveryContextFactory() {
            return new NacosDiscoveryContextFactory();
        }
